const SectionTitle = ({heading, subHeading, isFeatured}) => {
  return (
    <div className="w-3/4 md:w-4/12 lg:w-3/12 mx-auto text-center mt-[70px] mb-[30px]">
      ...
      <h3 className={`text-2xl md:text-3xl ${isFeatured? 'text-white' : 'text-headingColor'}  font-heading uppercase border-b-2 pb-2`}>{heading}</h3>
    </div>
  );
};
